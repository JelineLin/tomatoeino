...
Schema: {"title":"...","passage":"...","vocabulary":[{"word":"...","meaning":"中文","example":"...","pronunciation":"..."}],"questions":[{"id":"q1","type":"main_idea|detail|inference|grammar_in_context|matching_heading","prompt":"...","options":["A...","B...","C...","D..."],"answer":"A","explanation":"中文"}],"generation_reason":"中文","estimated_minutes":45}.
Produce 8-12 vocabulary items and exactly 3 questions. Answers must be one of A/B/C/D.
...
For IELTS mode, create original IELTS-style tasks and never call them official questions.`
	...
	if strings.TrimSpace(out.Title) == "" || wordCount < 250 || wordCount > 350 || len(out.Vocabulary) < 8 || len(out.Vocabulary) > 12 || len(out.Questions) != 3 {
		return Lesson{}, fmt.Errorf("课程结构不完整：正文需 250～350 词、词汇需 8～12 个、题目需 3 道")
	}
